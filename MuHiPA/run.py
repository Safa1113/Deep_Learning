...
if __name__ == '__main__':
    ...
    using = "-o /home/abr/Data/murel.bootstrap.pytorch/murel/options/vqa2/murel.yaml"
    vcp2 = "-o /home/abr/Data/murel.bootstrap.pytorch/murel/options/vqacp2/murel.yaml"
    #s1 = "-m run -o /home/abr/Data/murel.bootstrap.pytorch/murel/options/vqa2/murel.yaml"
    #s = "/home/abr/Data/murel.bootstrap.pytorch/murel/options/vqa2/murel.yaml"
    s2 = "-o logs/vqa2/murel/options.yaml --exp.resume last"
    reproduce_results = "python -m bootstrap.run -o murel/options/vqa2/murel.yaml --exp.dir logs/vqa2/murel"
    resume = "--exp.resume last"
    print(run)
    main(run=run)
#export PYTHONPATH=$PYTHONPATH:/home/abr/Data/murel.bootstrap.pytorch/murel