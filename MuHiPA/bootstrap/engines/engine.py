...
class Engine(object):
    ...
    def train_epoch(self, model, dataset, optimizer, epoch, mode='train'):
        ...
        for i, batch in enumerate(batch_loader):
            ...
            optimizer.zero_grad()
            out = model(batch)
#            print("ouuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuutttt")
#            print(out.keys())
    ...
    def eval_epoch(self, model, dataset, epoch, mode='eval', logs_json=True):
        ...
        for i, batch in enumerate(batch_loader):
            ...
            # print("Saving to representations.json.....")
            # representations = out['representations']
                
            # with open("/home/abr/Data/EMuRelPAFramework/EMuRelPA/models/networks/representations_original2.json", "w") as fp:
                # json.dump(representations, fp)
